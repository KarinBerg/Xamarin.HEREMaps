...
namespace Xamarin.HEREMaps.iOS
{
	...
	interface NMAMapTileLayerDataSource
	{
		...
		string MapTileLayerUrlForTileAtX(NMAMapTileLayer mapTileLayer, nuint x, nuint y, nuint zoomLevel);
		...
		void MapTileLayerRequestDataForTileAtX(NMAMapTileLayer mapTileLayer, nuint x, nuint y, nuint zoomLevel, NMAMapTileRequest tileRequest);
		...
		NSData MapTileLayerRequestDataForTileAtX(NMAMapTileLayer mapTileLayer, nuint x, nuint y, nuint zoomLevel);
	}
	...
	interface NMAMapViewDelegate
	{
		...
		// TODO: Fix this later
		// Error was: BTOUCH : error BI1017: bgen: Do not know how to make a signature for System.Void* in parameter `bitmap' from Xamarin.HEREMaps.iOS.NMAMapViewDelegate.MapView
	...
	{
		// TODO: Fix this later
		// Error was: BTOUCH : error BI1017: bgen: Do not know how to make a signature for System.Void* in method `get_BytesPtr'
	...
	interface NMAVenue3dMapLayerDelegate
	{
		...
		void VenueMapLayerDidChangeFromLevel(NMAVenue3dMapLayer venueMapLayer, NMAVenue3dLevel oldLevel, NMAVenue3dLevel newLevel, NMAVenue3dVenue venue);
	...
	interface NMAVenue3dVenueRouteSection
	{
		...
		[Export("boundingBox:")]
		[return: NullAllowed]
		NMAGeoBoundingBox BoundingBoxForLevel(NMAVenue3dLevel level);
