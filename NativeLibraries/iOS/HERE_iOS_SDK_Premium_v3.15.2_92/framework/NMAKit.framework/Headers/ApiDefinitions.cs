...
namespace Xamarin.HEREMaps.iOS
{
	...
	interface NMANavigationManagerDelegate
	{
		...
		void NavigationManager (NMANavigationManager navigationManager, [NullAllowed] NMAManeuver currentManeuver, [NullAllowed] NMAManeuver nextManeuver);
		...
		void NavigationManager (NMANavigationManager navigationManager, NMAWaypoint stopover);
		...
		void NavigationManager (NMANavigationManager navigationManager, NMARouteResult routeResult);
		...
		void NavigationManager (NMANavigationManager navigationManager, NMALaneInformation[] laneInformations, [NullAllowed] NMARoadElement roadElement);
		...
		void NavigationManager (NMANavigationManager navigationManager, NSDictionary<NSNumber, NSDictionary<NSString, NMAImage>> realisticViews);
		...
		void NavigationManager (NMANavigationManager navigationManager, bool isSpeeding, float speed, float speedLimit);
		...
		void NavigationManager (NMANavigationManager navigationManager, NMARoutingError error);
		...
		void NavigationManager (NMANavigationManager navigationManager, NMATrafficEnabledRoutingState state);
		...
		bool NavigationManager (NMANavigationManager navigationManager, [NullAllowed] string text);
		...
		void NavigationManager (NMANavigationManager navigationManager, [NullAllowed] string text);
		...
		void NavigationManager (NMANavigationManager navigationManager, string previousCountry, string nextCountry);
	}
	...
	[BaseType (typeof(NSObject))]
	interface NMADevicePositionSource : INMAPositionDataSource, ICLLocationManagerDelegate
	{
	...
	[BaseType (typeof(NSObject))]
	interface NMAHEREPositionSource : INMAPositionDataSource
	{
	...
	[BaseType (typeof(NSObject))]
	interface NMALoggedPositionSource : INMAPositionDataSource
	{
	...
	[Protocol, Model]
	interface NMAPositionDataSourceAutomotive : INMAPositionDataSource
	{
	...
	[BaseType (typeof(NSObject))]
	interface NMARoutePositionSource : INMAPositionDataSource
	{
	...
	interface NMAElectronicHorizonDelegate
	{
		...
		void ElectronicHorizon (NMAElectronicHorizon electronicHorizon, NMAEHPosition position);
		...
		void ElectronicHorizon (NMAElectronicHorizon electronicHorizon, NMAEHPathTree pathTree, NMAEHLink link);
		...
		void ElectronicHorizon (NMAElectronicHorizon electronicHorizon, NMAEHPathTree pathTree);
		...
		void ElectronicHorizon (NMAElectronicHorizon electronicHorizon, NMAEHPathTree parent, NMAEHPathTree child);
	}
	...
	interface NMAHistoricalTrafficTileLayer : INMAMapTileLayerDataSource
	{
	...
	interface NMAMapLoaderDelegate
	{
		...
		void MapLoader (NMAMapLoader mapLoader, float progress);
		...
		void MapLoader (NMAMapLoader mapLoader, NMAMapLoaderResult mapLoaderResult);
		...
		void MapLoader (NMAMapLoader mapLoader, bool updateIsAvailable, string currentMapVersion, string newestMapVersion, NMAMapLoaderResult mapLoaderResult);
		...
		void MapLoader (NMAMapLoader mapLoader, nuint size, NMAMapLoaderResult mapLoaderResult);
		...
		void MapLoader (NMAMapLoader mapLoader, [NullAllowed] NMAMapPackage package, NMAGeoCoordinates coordinates, NMAMapLoaderResult mapLoaderResult);
	...
	interface NMANavigationManager_NMANavigationManagerVoicePromptOptions
	{
		...
		void SetMinimumDistance (nint minimumDistance, NMANavigationVoicePromptType voicePromptType, NMANavigationRoadType roadType);
		...
		void SetMaximumDistance (nint maximumDistance, NMANavigationVoicePromptType voicePromptType, NMANavigationRoadType roadType);
		...
		void SetMinimumTimeInterval (double minimumTime, NMANavigationVoicePromptType voicePromptType, NMANavigationRoadType roadType);
		...
		void SetMaximumTimeInterval (double maximumTime, NMANavigationVoicePromptType voicePromptType, NMANavigationRoadType roadType);
		...
		void SetTimeBasedDistance (nint distance, NMANavigationVoicePromptType voicePromptType, NMANavigationRoadType roadType);
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface NMAPlaceTransitOperator
	{
		// @property (readonly, nonatomic) NSString * _Nullable uniqueId;
		[NullAllowed, Export ("uniqueId")]
		string UniqueId { get; }
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface NMAPlaceTransitOperatorLink
	{
		// @property (readonly, nonatomic) NSString * _Nullable text;
		[NullAllowed, Export ("text")]
		string Text { get; }
	...
	interface NMAMapDataPrefetcher
	{
		...
		unsafe nint FetchMapDataForBoundingBox (NMAGeoBoundingBox boundingBox, [NullAllowed] NMAPrefetchRequestError* error);
		...
		unsafe nint FetchMapDataForRoute (NMARoute route, nuint radius, [NullAllowed] NMAPrefetchRequestError* error);
		...
		unsafe nint EstimateMapDataSizeForBoundingBox (NMAGeoBoundingBox boundingBox, [NullAllowed] NMAPrefetchRequestError* error);
		...
		unsafe nint EstimateMapDataSizeForRoute (NMARoute route, nuint radius, [NullAllowed] NMAPrefetchRequestError* error);
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface NMAVenue3dSimulatedPositionSource : INMAPositionDataSource
	{
