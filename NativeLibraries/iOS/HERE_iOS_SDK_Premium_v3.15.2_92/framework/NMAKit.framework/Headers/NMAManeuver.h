 ...
 * 360, north is up, clockwise. For some aroundabouts, this angle is an approximation from the entry
 * to the exit point of the roundabout, which may be used for customization of the aroundabout icon.
 */
@property (nonatomic, readonly) NSUInteger angle;

/**
 * The `NMAGeoCoordinates` of the maneuver. If this maneuver contains
 * one or more transit route elements, this coordinate will be the same as
 * the coordinate of the 1st transit route element.
 */
 ...
 * @note  It is localized to the locale of the region.
 */
@property (nonatomic, readonly, weak, nullable) NSString *nextRoadName;
 ...
 * @note  It is localized to the locale of the region.
 */
@property (nonatomic, readonly, weak, nullable) NSString *roadNumber;
 ...
 * @note  It is localized to the locale of the region.
 */
@property (nonatomic, readonly, weak, nullable) NSString *nextRoadNumber;
 ...
 */
@property (nonatomic, readonly, weak, nullable) NSDate *startTime;
 ...
 *
 */
@property (nonatomic, readonly, nonnull) NSArray <NMAGeoCoordinates *> *maneuverGeometry;
 ...
 * nil if no next road icon for this maneuver.
 */
@property (nonatomic, readonly, nullable) NMAImage *nextRoadIcon;
 ...
 */
@property (nonatomic, readonly, nullable) NMASignpost *signpost;

/**
 * Gets the current `NMAManeuverTrafficDirection`, indicating whether the traffic
 * flows on the right or left side of the road
 */
@property (nonatomic, readonly) NMAManeuverTrafficDirection trafficDirection;
 ...
 */
@property (nonatomic, readonly, nonnull) NSArray<NMARouteElement *> *routeElements;
