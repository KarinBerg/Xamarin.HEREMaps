 ...
 *
 * @note The mesh is limited to 65536 NMAGeoCoordinates.
 *
 * @param vertices An array of NMAGeoCoordinates representing the mesh vertices.
 */
- (void)setVertices:(nonnull NSArray<NMAGeoCoordinates *> *)vertices;
 ...
 * should be 3 * count.
 */
- (void)setVertices:(nonnull const double *)vertices withCount:(NSUInteger)count
